...
<section class="container">
    ...
    <div class="container-card">
       ...
       <form action="controllers/postClients.php" method="POST" autocomplete="off" class="form">
            <div class="form__input-groups">
                <span class="form__description">Escribe el nombre</span>
                <input type="text" name="name_client" class="form__input" placeholder="Escriba el nombre" index="1">
            </div>
            <div class="form__input-groups">
                <span class="form__description">Escribe el apellido</span>
                <input type="text" name="lastname" class="form__input" placeholder="Escriba el apellido" index="2">
            </div>
            <div class="form__input-groups">
            ...
            <div class="form__input-groups">
                ...
                <input type="text" name="cellphone" class="form__input" placeholder="Escriba el numero telefono" index="4">
            </div>
            <div class="form__input-groups">
                <span class="form__description">Referencias</span>
                <input type="text" name="rferences" class="form__input" placeholder="Escriba las referencias" index="5">
            </div>
            <div class="form__input-groups">
                <span class="form__description">Escriba la direccion</span>
                <textarea name="address" cols="50"  rows="5" class="form__input--textarea" index="6"></textarea>
            </div>
